  ...
  <div class="container mt-2">
    <div v-for="(task, index) in tasks" :key="index">
      <b-card :title="task.subject" class="mb-2">
        ...
        <b-button variant="outline-secondary" class="mr-2" @click="edit(index)"> Atualizar </b-button>
        <b-button variant="outline-danger" class="mr-2" @click="remove(task, index)"> Deletar </b-button>
      </b-card> 
    </div>
    <b-modal ref="modalRemove" hide-footer title="Exclusão de tarefa">
      <div class="d-block text-center">
        Deseja excluir essa tarefa? {{ taskSelected.subject }}
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      confirmRemoveTask() {
        ...
        this.hideModal();
        this.showToast("danger", "Sucesso", "Tarefa removida com sucesso!");
      }
    }
  }
</script>